...
CREATE TABLE "main"."SvtTestTypeList" (
  "asicFamilyType" main."asicFamilyType" NOT NULL,
  "testTypeId" integer NOT NULL,
  "testConfigVersion" integer
);

CREATE TABLE "main"."SvtTestConfiguration" (
  "testTypeId" integer NOT NULL,
  "name" varchar(100),
  "versionId" integer UNIQUE NOT NULL,
...
ALTER TABLE "main"."Asic" ADD FOREIGN KEY ("chipId") REFERENCES "main"."Chip" ("id");
...
ALTER TABLE "main"."WaferProbeMachine" ADD FOREIGN KEY ("loadedWaferId") REFERENCES "main"."Wafer" ("id");

ALTER TABLE "main"."WaferProbeMachine" ADD FOREIGN KEY ("installedProbeCardId") REFERENCES "main"."ProbeCard" ("id");
...
ALTER TABLE "main"."SvtTestSetup" ADD FOREIGN KEY ("defaultConfigId") REFERENCES "main"."SvtTestSetupConfig" ("id");

ALTER TABLE "main"."SvtTestSetupEquipList" ADD FOREIGN KEY ("setup_id") REFERENCES "main"."SvtTestSetup" ("id");

ALTER TABLE "main"."SvtTestSetupEquipList" ADD FOREIGN KEY ("equip_id") REFERENCES "main"."Equipment" ("id");

ALTER TABLE "main"."SvtTestSetupConfig" ADD FOREIGN KEY ("baseId") REFERENCES "main"."SvtTestSetupConfig" ("id");

ALTER TABLE "main"."SvtTestSetupConfig" ADD FOREIGN KEY ("setupId") REFERENCES "main"."SvtTestSetup" ("id");

ALTER TABLE "main"."SvtTestTypeList" ADD FOREIGN KEY ("testTypeId") REFERENCES "main"."SvtTestType" ("id");

ALTER TABLE "main"."SvtTestTypeList" ADD FOREIGN KEY ("testConfigVersion") REFERENCES "main"."SvtTestConfiguration" ("versionId");

ALTER TABLE "main"."SvtTestConfiguration" ADD FOREIGN KEY ("testTypeId") REFERENCES "main"."SvtTestType" ("id");

ALTER TABLE "main"."SvtTestConfiguration" ADD FOREIGN KEY ("baseVersionId") REFERENCES "main"."SvtTestConfiguration" ("versionId");
